...
Task 12E1: in progress (code head 448632d; 84 focused tests and hygiene pass, but dual review found Important parse-cache key isolation and globally bounded retention/residue gaps; full pre-commit fails one stale ManifestArtifact test double; resume from checkpoint document before E2)
