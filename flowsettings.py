...
# Legacy GraphRAG index families are deprecated in the default single-page QA flow.
# Keep these constants for backward compatibility with external custom wiring.
