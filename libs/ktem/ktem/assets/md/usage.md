...
![MARA resources tab](../img/resources-tab.png)
...
![MARA files tab](../img/file-index-tab.png)
...
![MARA chat workbench](../img/chat-tab.png)
...
![MARA evidence and preview panel](../img/info-panel-scores.png)
...
![MARA knowledge graph preview](../img/preview-graph.png)
...
![MARA Studio artifacts](../img/mara-studio-artifacts.png)
