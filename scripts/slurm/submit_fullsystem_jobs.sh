...
HPC_HOME="${MARA_FULLSYSTEM_HPC_HOME:-/mnt/scratch/users/tbczhang/mara-hpc}"
...
source "$SERVICE_RUNTIME_PREFLIGHT"
mara_preflight_service_runtime "$HPC_HOME" full serve_qwen3_vl_8b_4k.sh
check_partitions
