...
_CSV_FIELD_ORDER = [
    ...
    "avg_abstention_rate",
    "num_terminal_answered",
    "num_terminal_true_abstention",
    "num_terminal_false_abstention",
    "num_terminal_execution_failed",
    "num_terminal_timeout",
    "num_terminal_cancelled",
    "num_terminal_unclassified",
    "terminal_outcome_contract_violation_count",
    "num_true_abstention",
