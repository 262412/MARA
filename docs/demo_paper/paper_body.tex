...
\caption{Live MARA UI screenshot on the non-sensitive demonstration document \texttt{ResearchProject.docx}: source selection, question, routed answer, citations, evidence preview, and controller trace in one QA workflow.}
\label{fig:ui}
\end{figure*}
