...
Python development, runtime modularisation, retrieval, multimodal indexing, controller design, Web/CLI integration, testing and optional analytical evaluation.
...
Boundary freeze, version control, route milestones, contract tests, demonstration planning, optional evaluation design, risk tracking and dissertation writing time.
