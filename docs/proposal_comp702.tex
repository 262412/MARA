...
\begin{itemize}
  ...
  \item To develop a Self-RAG-inspired controller that selects between direct answering, text retrieval, multimodal or structured evidence retrieval, graph context, hybrid retrieval and abstention.
...
\begin{itemize}
  ...
  \item A small labelled benchmark records questions, expected routes, accepted evidence and expected answers for technical evaluation.
\end{itemize}
